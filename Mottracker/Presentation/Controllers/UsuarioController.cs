...
{   
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        [SwaggerResponse(200, "Lista retornada com sucesso", typeof(IEnumerable<UsuarioEntity>))]
        ...
        [SwaggerResponse(200, "Usuário retornado com sucesso", typeof(UsuarioEntity))]
        ...
        [SwaggerResponse(201, "Usuário salvo com sucesso", typeof(UsuarioEntity))]
        [SwaggerResponse(400, "Erro ao salvar o dado")]
        public IActionResult Post([FromBody] UsuarioEntity entity)
        {
            try
            {
        ...
        [SwaggerResponse(200, "Usuário deletado com sucesso", typeof(UsuarioEntity))]
